...
shut_down = False
rockblock_in_every_n_lines = 151       # number of telemetry loops between rockblock send
camera_in_every_n_times = 79
...
while True:
    ...
    if telemetry_line_counter % camera_in_every_n_times == 0:
    ...
    if telemetry_line_counter % rockblock_in_every_n_lines == 0:
